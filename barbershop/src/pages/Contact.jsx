          ...
          <div className="row">
              ...
              <div className="col-lg-6 sm-padding">
                  <div className="contact-form">
                      <div id="contact_ajax_form" className="contactForm">
                          ...
                          {loading && <alt src="public/images/ajax_loader_gif.gif" id="contact_ajax_loader" style={{ display: 'block', margin: '0 auto' }} />}
